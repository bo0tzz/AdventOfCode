...
-file("/home/boet/git/AdventOfCode/2024/build/packages/gleam_stdlib/src/gleam/string.gleam", 23).
-spec is_empty(binary()) -> boolean().
is_empty(Str) ->
    Str =:= <<""/utf8>>.

-file("/home/boet/git/AdventOfCode/2024/build/packages/gleam_stdlib/src/gleam/string.gleam", 51).
-spec length(binary()) -> integer().
length(String) ->
    string:length(String).

-file("/home/boet/git/AdventOfCode/2024/build/packages/gleam_stdlib/src/gleam/string.gleam", 65).
...
-file("/home/boet/git/AdventOfCode/2024/build/packages/gleam_stdlib/src/gleam/string.gleam", 86).
...
-file("/home/boet/git/AdventOfCode/2024/build/packages/gleam_stdlib/src/gleam/string.gleam", 111).
-spec lowercase(binary()) -> binary().
lowercase(String) ->
    string:lowercase(String).

-file("/home/boet/git/AdventOfCode/2024/build/packages/gleam_stdlib/src/gleam/string.gleam", 127).
-spec uppercase(binary()) -> binary().
uppercase(String) ->
    string:uppercase(String).

-file("/home/boet/git/AdventOfCode/2024/build/packages/gleam_stdlib/src/gleam/string.gleam", 145).
...
-file("/home/boet/git/AdventOfCode/2024/build/packages/gleam_stdlib/src/gleam/string.gleam", 190).
...
-file("/home/boet/git/AdventOfCode/2024/build/packages/gleam_stdlib/src/gleam/string.gleam", 223).
-spec crop(binary(), binary()) -> binary().
crop(String, Substring) ->
    gleam_stdlib:crop_string(String, Substring).

-file("/home/boet/git/AdventOfCode/2024/build/packages/gleam_stdlib/src/gleam/string.gleam", 248).
...
-file("/home/boet/git/AdventOfCode/2024/build/packages/gleam_stdlib/src/gleam/string.gleam", 235).
-spec drop_left(binary(), integer()) -> binary().
drop_left(String, Num_graphemes) ->
    drop_start(String, Num_graphemes).

-file("/home/boet/git/AdventOfCode/2024/build/packages/gleam_stdlib/src/gleam/string.gleam", 278).
...
-file("/home/boet/git/AdventOfCode/2024/build/packages/gleam_stdlib/src/gleam/string.gleam", 265).
-spec drop_right(binary(), integer()) -> binary().
drop_right(String, Num_graphemes) ->
    drop_end(String, Num_graphemes).

-file("/home/boet/git/AdventOfCode/2024/build/packages/gleam_stdlib/src/gleam/string.gleam", 306).
-spec contains(binary(), binary()) -> boolean().
contains(Haystack, Needle) ->
    gleam_stdlib:contains_string(Haystack, Needle).

-file("/home/boet/git/AdventOfCode/2024/build/packages/gleam_stdlib/src/gleam/string.gleam", 319).
-spec starts_with(binary(), binary()) -> boolean().
starts_with(String, Prefix) ->
    gleam_stdlib:string_starts_with(String, Prefix).

-file("/home/boet/git/AdventOfCode/2024/build/packages/gleam_stdlib/src/gleam/string.gleam", 332).
-spec ends_with(binary(), binary()) -> boolean().
ends_with(String, Suffix) ->
    gleam_stdlib:string_ends_with(String, Suffix).

-file("/home/boet/git/AdventOfCode/2024/build/packages/gleam_stdlib/src/gleam/string.gleam", 371).
...
-file("/home/boet/git/AdventOfCode/2024/build/packages/gleam_stdlib/src/gleam/string.gleam", 397).
...
-file("/home/boet/git/AdventOfCode/2024/build/packages/gleam_stdlib/src/gleam/string.gleam", 417).
...
-file("/home/boet/git/AdventOfCode/2024/build/packages/gleam_stdlib/src/gleam/string.gleam", 438).
...
-file("/home/boet/git/AdventOfCode/2024/build/packages/gleam_stdlib/src/gleam/string.gleam", 434).
-spec repeat(binary(), integer()) -> binary().
repeat(String, Times) ->
    repeat_loop(String, Times, <<""/utf8>>).

-file("/home/boet/git/AdventOfCode/2024/build/packages/gleam_stdlib/src/gleam/string.gleam", 457).
...
-file("/home/boet/git/AdventOfCode/2024/build/packages/gleam_stdlib/src/gleam/string.gleam", 585).
...
-file("/home/boet/git/AdventOfCode/2024/build/packages/gleam_stdlib/src/gleam/string.gleam", 510).
...
-file("/home/boet/git/AdventOfCode/2024/build/packages/gleam_stdlib/src/gleam/string.gleam", 483).
-spec pad_left(binary(), integer(), binary()) -> binary().
pad_left(String, Desired_length, Pad_string) ->
    pad_start(String, Desired_length, Pad_string).

-file("/home/boet/git/AdventOfCode/2024/build/packages/gleam_stdlib/src/gleam/string.gleam", 571).
...
-file("/home/boet/git/AdventOfCode/2024/build/packages/gleam_stdlib/src/gleam/string.gleam", 544).
-spec pad_right(binary(), integer(), binary()) -> binary().
pad_right(String, Desired_length, Pad_string) ->
    pad_end(String, Desired_length, Pad_string).

-file("/home/boet/git/AdventOfCode/2024/build/packages/gleam_stdlib/src/gleam/string.gleam", 608).
-spec trim(binary()) -> binary().
trim(String) ->
    string:trim(String, both).

-file("/home/boet/git/AdventOfCode/2024/build/packages/gleam_stdlib/src/gleam/string.gleam", 645).
-spec trim_start(binary()) -> binary().
trim_start(String) ->
    string:trim(String, leading).

-file("/home/boet/git/AdventOfCode/2024/build/packages/gleam_stdlib/src/gleam/string.gleam", 631).
-spec trim_left(binary()) -> binary().
trim_left(String) ->
    trim_start(String).

-file("/home/boet/git/AdventOfCode/2024/build/packages/gleam_stdlib/src/gleam/string.gleam", 673).
-spec trim_end(binary()) -> binary().
trim_end(String) ->
    string:trim(String, trailing).

-file("/home/boet/git/AdventOfCode/2024/build/packages/gleam_stdlib/src/gleam/string.gleam", 659).
-spec trim_right(binary()) -> binary().
trim_right(String) ->
    trim_end(String).

-file("/home/boet/git/AdventOfCode/2024/build/packages/gleam_stdlib/src/gleam/string.gleam", 698).
-spec pop_grapheme(binary()) -> {ok, {binary(), binary()}} | {error, nil}.
pop_grapheme(String) ->
    gleam_stdlib:string_pop_grapheme(String).

-file("/home/boet/git/AdventOfCode/2024/build/packages/gleam_stdlib/src/gleam/string.gleam", 714).
...
-file("/home/boet/git/AdventOfCode/2024/build/packages/gleam_stdlib/src/gleam/string.gleam", 709).
-spec to_graphemes(binary()) -> list(binary()).
to_graphemes(String) ->
    _pipe = to_graphemes_loop(String, []),
    lists:reverse(_pipe).

-file("/home/boet/git/AdventOfCode/2024/build/packages/gleam_stdlib/src/gleam/string.gleam", 343).
...
-file("/home/boet/git/AdventOfCode/2024/build/packages/gleam_stdlib/src/gleam/string.gleam", 761).
...
-file("/home/boet/git/AdventOfCode/2024/build/packages/gleam_stdlib/src/gleam/string.gleam", 756).
-spec do_to_utf_codepoints(binary()) -> list(integer()).
do_to_utf_codepoints(String) ->
    to_utf_codepoints_loop(<<String/binary>>, []).

-file("/home/boet/git/AdventOfCode/2024/build/packages/gleam_stdlib/src/gleam/string.gleam", 751).
-spec to_utf_codepoints(binary()) -> list(integer()).
to_utf_codepoints(String) ->
    do_to_utf_codepoints(String).

-file("/home/boet/git/AdventOfCode/2024/build/packages/gleam_stdlib/src/gleam/string.gleam", 801).
...
-file("/home/boet/git/AdventOfCode/2024/build/packages/gleam_stdlib/src/gleam/string.gleam", 807).
...
-file("/home/boet/git/AdventOfCode/2024/build/packages/gleam_stdlib/src/gleam/string.gleam", 828).
-spec utf_codepoint_to_int(integer()) -> integer().
utf_codepoint_to_int(Cp) ->
    gleam_stdlib:identity(Cp).

-file("/home/boet/git/AdventOfCode/2024/build/packages/gleam_stdlib/src/gleam/string.gleam", 845).
...
-file("/home/boet/git/AdventOfCode/2024/build/packages/gleam_stdlib/src/gleam/string.gleam", 868).
...
-file("/home/boet/git/AdventOfCode/2024/build/packages/gleam_stdlib/src/gleam/string.gleam", 891).
...
-file("/home/boet/git/AdventOfCode/2024/build/packages/gleam_stdlib/src/gleam/string.gleam", 909).
...
-file("/home/boet/git/AdventOfCode/2024/build/packages/gleam_stdlib/src/gleam/string.gleam", 918).
-spec inspect(any()) -> binary().
inspect(Term) ->
    _pipe = gleam_stdlib:inspect(Term),
    unicode:characters_to_binary(_pipe).

-file("/home/boet/git/AdventOfCode/2024/build/packages/gleam_stdlib/src/gleam/string.gleam", 941).

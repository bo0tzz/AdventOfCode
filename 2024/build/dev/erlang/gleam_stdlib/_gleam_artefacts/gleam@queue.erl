...
-file("/home/boet/git/AdventOfCode/2024/build/packages/gleam_stdlib/src/gleam/queue.gleam", 24).
-spec new() -> queue(any()).
new() ->
    {queue, [], []}.

-file("/home/boet/git/AdventOfCode/2024/build/packages/gleam_stdlib/src/gleam/queue.gleam", 41).
-spec from_list(list(EVP)) -> queue(EVP).
from_list(List) ->
    {queue, [], List}.

-file("/home/boet/git/AdventOfCode/2024/build/packages/gleam_stdlib/src/gleam/queue.gleam", 58).
-spec to_list(queue(EVS)) -> list(EVS).
to_list(Queue) ->
    _pipe = erlang:element(3, Queue),
    lists:append(_pipe, lists:reverse(erlang:element(2, Queue))).

-file("/home/boet/git/AdventOfCode/2024/build/packages/gleam_stdlib/src/gleam/queue.gleam", 85).
-spec is_empty(queue(any())) -> boolean().
is_empty(Queue) ->
    (erlang:element(2, Queue) =:= []) andalso (erlang:element(3, Queue) =:= []).

-file("/home/boet/git/AdventOfCode/2024/build/packages/gleam_stdlib/src/gleam/queue.gleam", 112).
...
-file("/home/boet/git/AdventOfCode/2024/build/packages/gleam_stdlib/src/gleam/queue.gleam", 126).
-spec push_back(queue(EVZ), EVZ) -> queue(EVZ).
push_back(Queue, Item) ->
    {queue, [Item | erlang:element(2, Queue)], erlang:element(3, Queue)}.

-file("/home/boet/git/AdventOfCode/2024/build/packages/gleam_stdlib/src/gleam/queue.gleam", 140).
-spec push_front(queue(EWC), EWC) -> queue(EWC).
push_front(Queue, Item) ->
    {queue, erlang:element(2, Queue), [Item | erlang:element(3, Queue)]}.

-file("/home/boet/git/AdventOfCode/2024/build/packages/gleam_stdlib/src/gleam/queue.gleam", 173).
...
-file("/home/boet/git/AdventOfCode/2024/build/packages/gleam_stdlib/src/gleam/queue.gleam", 213).
...
-file("/home/boet/git/AdventOfCode/2024/build/packages/gleam_stdlib/src/gleam/queue.gleam", 247).
-spec reverse(queue(EWP)) -> queue(EWP).
reverse(Queue) ->
    {queue, erlang:element(3, Queue), erlang:element(2, Queue)}.

-file("/home/boet/git/AdventOfCode/2024/build/packages/gleam_stdlib/src/gleam/queue.gleam", 271).
-spec check_equal(
    list(EWV),
    list(EWV),
    list(EWV),
...
-file("/home/boet/git/AdventOfCode/2024/build/packages/gleam_stdlib/src/gleam/queue.gleam", 263).
...
-file("/home/boet/git/AdventOfCode/2024/build/packages/gleam_stdlib/src/gleam/queue.gleam", 301).

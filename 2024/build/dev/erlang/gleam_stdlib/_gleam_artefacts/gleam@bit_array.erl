...
-file("/home/boet/git/AdventOfCode/2024/build/packages/gleam_stdlib/src/gleam/bit_array.gleam", 11).
-spec from_string(binary()) -> bitstring().
from_string(X) ->
    gleam_stdlib:identity(X).

-file("/home/boet/git/AdventOfCode/2024/build/packages/gleam_stdlib/src/gleam/bit_array.gleam", 24).
-spec byte_size(bitstring()) -> integer().
byte_size(X) ->
    erlang:byte_size(X).

-file("/home/boet/git/AdventOfCode/2024/build/packages/gleam_stdlib/src/gleam/bit_array.gleam", 16).
-spec bit_size(bitstring()) -> integer().
bit_size(X) ->
    erlang:bit_size(X).

-file("/home/boet/git/AdventOfCode/2024/build/packages/gleam_stdlib/src/gleam/bit_array.gleam", 29).
-spec pad_to_bytes(bitstring()) -> bitstring().
pad_to_bytes(X) ->
    gleam_stdlib:bit_array_pad_to_bytes(X).

-file("/home/boet/git/AdventOfCode/2024/build/packages/gleam_stdlib/src/gleam/bit_array.gleam", 56).
...
-file("/home/boet/git/AdventOfCode/2024/build/packages/gleam_stdlib/src/gleam/bit_array.gleam", 69).
...
-file("/home/boet/git/AdventOfCode/2024/build/packages/gleam_stdlib/src/gleam/bit_array.gleam", 64).
-spec is_utf8(bitstring()) -> boolean().
is_utf8(Bits) ->
    is_utf8_loop(Bits).

-file("/home/boet/git/AdventOfCode/2024/build/packages/gleam_stdlib/src/gleam/bit_array.gleam", 90).
...
-file("/home/boet/git/AdventOfCode/2024/build/packages/gleam_stdlib/src/gleam/bit_array.gleam", 111).
-spec concat(list(bitstring())) -> bitstring().
concat(Bit_arrays) ->
    gleam_stdlib:bit_array_concat(Bit_arrays).

-file("/home/boet/git/AdventOfCode/2024/build/packages/gleam_stdlib/src/gleam/bit_array.gleam", 42).
-spec append(bitstring(), bitstring()) -> bitstring().
append(First, Second) ->
    gleam_stdlib:bit_array_concat([First, Second]).

-file("/home/boet/git/AdventOfCode/2024/build/packages/gleam_stdlib/src/gleam/bit_array.gleam", 120).
-spec base64_encode(bitstring(), boolean()) -> binary().
base64_encode(Input, Padding) ->
    gleam_stdlib:bit_array_base64_encode(Input, Padding).

-file("/home/boet/git/AdventOfCode/2024/build/packages/gleam_stdlib/src/gleam/bit_array.gleam", 124).
...
-file("/home/boet/git/AdventOfCode/2024/build/packages/gleam_stdlib/src/gleam/bit_array.gleam", 142).
...
-file("/home/boet/git/AdventOfCode/2024/build/packages/gleam_stdlib/src/gleam/bit_array.gleam", 151).
...
-file("/home/boet/git/AdventOfCode/2024/build/packages/gleam_stdlib/src/gleam/bit_array.gleam", 165).
-spec base16_encode(bitstring()) -> binary().
base16_encode(Input) ->
    gleam_stdlib:base16_encode(Input).

-file("/home/boet/git/AdventOfCode/2024/build/packages/gleam_stdlib/src/gleam/bit_array.gleam", 171).
-spec base16_decode(binary()) -> {ok, bitstring()} | {error, nil}.
base16_decode(Input) ->
    gleam_stdlib:base16_decode(Input).

-file("/home/boet/git/AdventOfCode/2024/build/packages/gleam_stdlib/src/gleam/bit_array.gleam", 190).
...
-file("/home/boet/git/AdventOfCode/2024/build/packages/gleam_stdlib/src/gleam/bit_array.gleam", 185).
-spec inspect(bitstring()) -> binary().
inspect(Input) ->
    <<(inspect_loop(Input, <<"<<"/utf8>>))/binary, ">>"/utf8>>.

-file("/home/boet/git/AdventOfCode/2024/build/packages/gleam_stdlib/src/gleam/bit_array.gleam", 232).
...
-file("/home/boet/git/AdventOfCode/2024/build/packages/gleam_stdlib/src/gleam/bit_array.gleam", 272).
